...
export const enrichmentConfigSchema = z.object({
  ...
  fallback: fallbackConfigSchema.default({ enabled: false, order: ["signalhire", "hunter", "apollo"], maxLookupsPerRun: 5, maxLookupsPerDay: 25, maxFreeCallsPerRun: 6, operations: { company: true, people: true, emails: true, verify: true } }),
